...
MAIN="$PROJECT/bazel-bin/example/floyd" # process name
WNUM=1
WCORES=6
...
PARAMS+=" --input ${INPUT}  --is_directed=${IS_DIRECTED}  --vtype=${VTYPE} --need_encode=${NEED_ENCODE} "
